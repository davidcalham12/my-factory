...
| 2026-09-23 | Langfuse — SDK Python v4 | https://langfuse.com/docs/sdk/python/sdk-v3 · https://langfuse.com/docs/evaluation/evaluation-methods/custom-scores · https://langfuse.com/docs/prompt-management/get-started · https://langfuse.com/docs/observability/features/sessions · https://langfuse.com/docs/observability/features/masking | skill `langfuse`; v4 es OTel bajo el capó y `get_client()`, no los constructores de v3; `LANGFUSE_BASE_URL` decide la región |
| 2026-09-23 | Pydantic v2 — modelos y validación | https://pydantic.dev/docs/validation/latest/concepts/models/ | skill `pydantic`; el `Brief` del examen y el esquema de salida de cada rol |
| 2026-09-23 | Playwright Python — `page.pdf` | https://playwright.dev/python/docs/api/class-page#page-pdf | skill `playwright`; el PDF de la novela se imprime con Chromium, sin librería de PDF |
| 2026-09-23 | StoryMaker — repositorio del examen | https://github.com/davidcalham12/StoryMaker | el canónico: código, specs aprobadas, novela de ejemplo, evals; clonado de `novaforge-v2` con historia |
| 2026-09-24 | My-story — copia completa de StoryMaker | https://github.com/davidcalham12/My-story | el dueño confirmó que lleva todo; fusionado conservando su historia, lo anterior en `historico/`; cada push va a los dos |
| 2026-09-24 | Langfuse — región US | https://us.cloud.langfuse.com | donde vive el proyecto; `LANGFUSE_BASE_URL` apunta aquí (el SDK va a EU por defecto) |
| 2026-09-24 | Langfuse — API pública (referencia) | https://api.reference.langfuse.com | en esta organización los GET antiguos (`/api/public/traces`, `/scores`, `/sessions`) devuelven 410 `LEGACY_API_UNAVAILABLE`; las lecturas pasan a `/api/public/v2/observations` y `/api/public/v3/scores`; el `--replace` del exportador espera al borrado leyendo v2 |
| 2026-09-24 | Precios de Claude — caché | https://platform.claude.com/docs/en/about-claude/pricing | escritura de caché 1,25× y lectura 0,1× la entrada: con ellas se estima el coste de cada llamada a agente a partir de sus cuatro cifras de uso |
| 2026-09-24 | Claude Code — referencia de la CLI | https://docs.claude.com/en/docs/claude-code/cli-reference | `--agent`, `--model`, `--max-budget-usd`, `--json-schema`, `stream-json` con `--verbose`; base del juez, del cambio del lector y del bucle del capítulo en Python (SPEC-EXAM-006) |
| 2026-09-24 | Google Fonts — DM Sans | https://fonts.google.com/specimen/DM+Sans | tipografía del panel en el restyling del frontend |
